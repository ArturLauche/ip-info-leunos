...
export function SourceDiagnosticsSection({
  ...
  return (
    <section
      aria-label={t.asnSourceDiagnostics}
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border/60 bg-muted/40">
              <th
                scope="col"
                className="px-3 py-2 text-start text-[11px] font-semibold tracking-wider text-muted-foreground uppercase"
              >
              ...
              <th
                scope="col"
                className="px-3 py-2 text-end text-[11px] font-semibold tracking-wider text-muted-foreground uppercase"
              >
            ...
            {rows.map((row) => (
              ...
              >
                ...
                <td className="px-3 py-2 text-end font-mono text-xs text-muted-foreground tabular-nums">
                  {row.durationMs === null
                    ? "—"
                    : `${formatNumber(row.durationMs, locale)} ms`}
                </td>
