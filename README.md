...
Set `PRIVACY_CONTROLLER_NAME` to the controller's identity (name / legal entity) named on the privacy page, as required by GDPR Art. 13(1)(a). It is deployment-specific and not hardcoded; when unset the page falls back to a neutral "operator of this site (identity available on request)" note.
