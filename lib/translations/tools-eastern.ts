...
> = {
  pl: {
    ...
    asnTabRouting: "Routowanie",
    asnTabPrefixes: "Prefiksy",
    asnTabPeering: "Peering",
    asnTabSources: "Źródła",
    asnDetailNavLabel: "Szczegóły ASN",
    asnIdentityEyebrow: "System autonomiczny",
    asnCopyAsn: "Kopiuj ASN",
    asnLabelType: "Typ",
    asnLabelRegistry: "Rejestr",
    asnLabelDomain: "Domena",
    asnNetworkTypes: {
      isp: "ISP",
      hosting: "Hosting",
      business: "Firmy",
      education: "Edukacja",
      government: "Administracja państwowa",
      inactive: "Nieaktywna",
    },
    asnSourcesLabel: "Źródła",
    asnMetricIpv4Equivalent: "≈ odpowiednik /{bits}",
    asnMetricRequiresIpinfo: "Wymaga IPinfo",
    asnMetricNotReported: "Nie zgłoszono",
    asnMetricNoPeeringDb: "Brak profilu PeeringDB",
    asnFacilityCount: { one: "{count} obiekt", other: "{count} obiektów" },
    asnExchangeCount: { one: "{count} wymiana", other: "{count} wymian" },
    asnConnectionCount: {
      one: "{count} połączenie",
      other: "{count} połączeń",
    },
    asnShowMore: "Pokaż więcej ({count})",
    asnListedOfTotal: "{shown} z {total} na liście",
    asnNoneReported: "Brak danych",
    asnRelationV4Peers: "Peery IPv4",
    asnRelationV6Peers: "Peery IPv6",
    asnRelationObservedVia: "Wagi i liczba peerów obserwowane przez {source}.",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "Prawidłowy",
    asnRpkiInvalidShort: "Nieprawidłowy",
    asnLabelExchanges: "Wymiany",
    asnLabelFacilities: "Obiekty",
    asnLabelPeeringDbRecord: "Wpis PeeringDB",
    asnViewOnPeeringDb: "Zobacz {name} w PeeringDB",
    asnIxNotOperational: "Nieczynne",
    asnSortLabel: "Sortuj",
    asnSortDefault: "Kolejność dostawcy",
    asnSameAsn: "Ten sam ASN",
    asnExamplesLabel: "Wypróbuj",
    asnLabelPolicy: "Polityka",
    asnCountryCount: { one: "w {count} kraju", other: "w {count} krajach" },
  ...
  "pt-BR": {
    ...
    asnTabRouting: "Roteamento",
    asnTabPrefixes: "Prefixos",
    asnTabPeering: "Peering",
    asnTabSources: "Fontes",
    asnDetailNavLabel: "Detalhes do ASN",
    asnIdentityEyebrow: "Sistema autônomo",
    asnCopyAsn: "Copiar ASN",
    asnLabelType: "Tipo",
    asnLabelRegistry: "Registro",
    asnLabelDomain: "Domínio",
    asnNetworkTypes: {
      isp: "ISP",
      hosting: "Hospedagem",
      business: "Empresa",
    ...
    asnSourcesLabel: "Fontes",
    asnMetricIpv4Equivalent: "≈ equivalente a /{bits}",
    asnMetricRequiresIpinfo: "Requer IPinfo",
    asnMetricNotReported: "Não reportado",
    asnMetricNoPeeringDb: "Sem perfil do PeeringDB",
    asnFacilityCount: {
      one: "{count} instalação",
      other: "{count} instalações",
    },
    asnExchangeCount: { one: "{count} troca", other: "{count} trocas" },
    asnConnectionCount: { one: "{count} conexão", other: "{count} conexões" },
    asnShowMore: "Mostrar mais {count}",
    asnListedOfTotal: "{shown} de {total} listados",
    asnNoneReported: "Nenhum dado reportado",
    asnRelationV4Peers: "Pares IPv4",
    asnRelationV6Peers: "Pares IPv6",
    asnRelationObservedVia: "Peso e número de pares observados via {source}.",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "Válido",
    asnRpkiInvalidShort: "Inválido",
    asnLabelExchanges: "Trocas",
    asnLabelFacilities: "Instalações",
    asnLabelPeeringDbRecord: "Registro do PeeringDB",
    asnViewOnPeeringDb: "Ver {name} no PeeringDB",
    asnIxNotOperational: "Não operacional",
    asnSortLabel: "Classificar",
    asnSortDefault: "Ordem do provedor",
    asnSameAsn: "Mesmo ASN deste",
    asnExamplesLabel: "Testar",
    asnLabelPolicy: "Política",
    asnCountryCount: { one: "em {count} país", other: "em {count} países" },
    targetPlaceholder: "example.com",
  ...
  "pt-PT": {
    ...
    asnMetricIpv4Equivalent: "≈ equivalente a /{bits}",
    asnMetricRequiresIpinfo: "Requer IPinfo",
    asnMetricNotReported: "Não comunicado",
    asnMetricNoPeeringDb: "Sem perfil do PeeringDB",
    asnFacilityCount: {
      one: "{count} instalação",
      other: "{count} instalações",
    ...
    asnExchangeCount: { one: "{count} troca", other: "{count} trocas" },
    asnConnectionCount: { one: "{count} ligação", other: "{count} ligações" },
    asnShowMore: "Mostrar mais {count}",
    asnListedOfTotal: "{shown} de {total} listados",
    asnNoneReported: "Nenhum dado comunicado",
    asnRelationV4Peers: "Pares IPv4",
    asnRelationV6Peers: "Pares IPv6",
    asnRelationObservedVia:
      "Peso e número de pares observados através de {source}.",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "Válido",
    asnRpkiInvalidShort: "Inválido",
    asnLabelExchanges: "Trocas",
    asnLabelFacilities: "Instalações",
    asnLabelPeeringDbRecord: "Registo do PeeringDB",
    asnViewOnPeeringDb: "Ver {name} no PeeringDB",
    asnIxNotOperational: "Não operacional",
    asnSortLabel: "Ordenar",
    asnSortDefault: "Ordem do fornecedor",
    asnSameAsn: "Mesmo ASN deste",
    asnExamplesLabel: "Testar",
    asnLabelPolicy: "Política",
    asnCountryCount: { one: "em {count} país", other: "em {count} países" },
  ...
  ja: {
    ...
    asnTabRouting: "ルーティング",
    asnTabPrefixes: "プレフィックス",
    asnTabPeering: "Peering",
    asnTabSources: "ソース",
    asnDetailNavLabel: "ASN の詳細",
    asnIdentityEyebrow: "自律システム",
    asnCopyAsn: "ASN をコピー",
    asnLabelType: "種別",
    asnLabelRegistry: "レジストリ",
    asnLabelDomain: "ドメイン",
    asnNetworkTypes: {
      isp: "ISP",
      hosting: "ホスティング",
    ...
    asnSourcesLabel: "ソース",
    asnMetricIpv4Equivalent: "≈ /{bits} 相当",
    asnMetricRequiresIpinfo: "IPinfo が必要",
    asnMetricNotReported: "未報告",
    asnMetricNoPeeringDb: "PeeringDB プロファイルなし",
    asnFacilityCount: { one: "{count} 施設", other: "{count} 施設" },
    asnExchangeCount: { one: "{count} 交換拠点", other: "{count} 交換拠点" },
    asnConnectionCount: { one: "{count} 接続", other: "{count} 接続" },
    asnShowMore: "さらに {count} 件表示",
    asnListedOfTotal: "{total} 件中 {shown} 件を表示",
    asnNoneReported: "報告はありません",
    asnRelationV4Peers: "IPv4 ピア",
    asnRelationV6Peers: "IPv6 ピア",
    asnRelationObservedVia: "重みとピア数は {source} による観測値です。",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "有効",
    asnRpkiInvalidShort: "無効",
    asnLabelExchanges: "交換",
    asnLabelFacilities: "施設",
    asnLabelPeeringDbRecord: "PeeringDB レコード",
    asnViewOnPeeringDb: "PeeringDB で {name} を表示",
    asnIxNotOperational: "非稼働",
    asnSortLabel: "並べ替え",
    asnSortDefault: "プロバイダー順",
    asnSameAsn: "この ASN と同じ",
    asnExamplesLabel: "試す",
    asnLabelPolicy: "ポリシー",
    asnCountryCount: { one: "{count} か国", other: "{count} か国" },
    targetPlaceholder: "example.com",
  ...
  ko: {
    ...
    asnTabPeering: "Peering",
    asnTabSources: "소스",
    asnDetailNavLabel: "ASN 세부 정보",
    asnIdentityEyebrow: "자율 시스템",
    asnCopyAsn: "ASN 복사",
    asnLabelType: "유형",
    asnLabelRegistry: "레지스트리",
    asnLabelDomain: "도메인",
    asnNetworkTypes: {
      isp: "ISP",
      hosting: "호스팅",
    ...
    asnSourcesLabel: "소스",
    asnMetricIpv4Equivalent: "≈ /{bits} 상당",
    asnMetricRequiresIpinfo: "IPinfo 필요",
    asnMetricNotReported: "보고되지 않음",
    asnMetricNoPeeringDb: "PeeringDB 프로필 없음",
    asnFacilityCount: { one: "{count} 시설", other: "{count} 시설" },
    asnExchangeCount: { one: "{count} 교환 지점", other: "{count} 교환 지점" },
    asnConnectionCount: { one: "{count} 연결", other: "{count} 연결" },
    asnShowMore: "{count}개 더 보기",
    asnListedOfTotal: "전체 {total}건 중 {shown}건 표시",
    asnNoneReported: "보고된 항목이 없습니다",
    asnRelationV4Peers: "IPv4 피어",
    asnRelationV6Peers: "IPv6 피어",
    asnRelationObservedVia: "가중치와 피어 수는 {source}에서 관찰된 값입니다.",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "유효",
    asnRpkiInvalidShort: "무효",
    asnLabelExchanges: "교환",
    asnLabelFacilities: "시설",
    asnLabelPeeringDbRecord: "PeeringDB 레코드",
    asnViewOnPeeringDb: "PeeringDB에서 {name} 보기",
    asnIxNotOperational: "운영되지 않음",
    asnSortLabel: "정렬",
    asnSortDefault: "제공업체 순서",
    asnSameAsn: "이 ASN과 동일",
    asnExamplesLabel: "테스트",
    asnLabelPolicy: "정책",
    asnCountryCount: { one: "{count}개국", other: "{count}개국" },
    targetPlaceholder: "example.com",
  ...
  ru: {
    ...
    asnTabRouting: "Маршрутизация",
    asnTabPrefixes: "Префиксы",
    asnTabPeering: "Пиринг",
    asnTabSources: "Источники",
    asnDetailNavLabel: "Сведения об ASN",
    asnIdentityEyebrow: "Автономная система",
    asnCopyAsn: "Копировать ASN",
    asnLabelType: "Тип",
    asnLabelRegistry: "Реестр",
    ...
    asnSourcesLabel: "Источники",
    asnMetricIpv4Equivalent: "≈ соответствует /{bits}",
    asnMetricRequiresIpinfo: "Требуется IPinfo",
    asnMetricNotReported: "Не сообщено",
    asnMetricNoPeeringDb: "Нет профиля PeeringDB",
    asnFacilityCount: { one: "{count} объект", other: "{count} объектов" },
    asnExchangeCount: {
      one: "{count} точка обмена",
      other: "{count} точек обмена",
    },
    asnConnectionCount: {
      one: "{count} подключение",
      other: "{count} подключений",
    },
    asnShowMore: "Показать ещё {count}",
    asnListedOfTotal: "Показано {shown} из {total}",
    asnNoneReported: "Нет данных",
    asnRelationV4Peers: "Пиры IPv4",
    asnRelationV6Peers: "Пиры IPv6",
    asnRelationObservedVia: "Веса и число пиров получены по данным {source}.",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "Действителен",
    asnRpkiInvalidShort: "Недействителен",
    asnLabelExchanges: "Обмены",
    asnLabelFacilities: "Объекты",
    asnLabelPeeringDbRecord: "Запись PeeringDB",
    asnViewOnPeeringDb: "Открыть {name} в PeeringDB",
    asnIxNotOperational: "Не работает",
    asnSortLabel: "Сортировка",
    asnSortDefault: "Порядок провайдера",
    asnSameAsn: "Такой же, как этот ASN",
    asnExamplesLabel: "Попробуйте",
    asnLabelPolicy: "Политика",
    asnCountryCount: { one: "в {count} стране", other: "в {count} странах" },
    targetPlaceholder: "example.com",
