...
> = {
  cs: {
    ...
    asnFacilityCount: { one: "{count} lokalita", other: "{count} lokalit" },
    asnExchangeCount: {
    ...
    asnCountryCount: { one: "ve {count} zemi", other: "ve {count} zemích" },
  ...
  ro: {
    ...
    asnFacilityCount: { one: "{count} locație", other: "{count} locații" },
    asnExchangeCount: {
      one: "{count} punct de schimb",
      other: "{count} puncte de schimb",
    },
    asnConnectionCount: {
      one: "{count} conexiune",
    ...
    asnCountryCount: { one: "în {count} țară", other: "în {count} țări" },
    targetPlaceholder: "example.com",
