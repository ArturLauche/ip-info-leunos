...
> = {
  cs: {
    ...
    asnTabRouting: "Směrování",
    asnTabPrefixes: "Prefixy",
    asnTabPeering: "Peering",
    asnTabSources: "Zdroje",
    asnDetailNavLabel: "Podrobnosti ASN",
    asnIdentityEyebrow: "Autonomní systém",
    asnCopyAsn: "Kopírovat ASN",
    asnLabelType: "Typ",
    asnLabelRegistry: "Registr",
    asnLabelDomain: "Doména",
    asnNetworkTypes: {
      isp: "ISP",
      hosting: "Hosting",
      business: "Podniky",
    ...
    asnSourcesLabel: "Zdroje",
    asnMetricIpv4Equivalent: "≈ odpovídá /{bits}",
    asnMetricRequiresIpinfo: "Vyžaduje IPinfo",
    asnMetricNotReported: "Neuvedeno",
    asnMetricNoPeeringDb: "Bez profilu PeeringDB",
    asnFacilityCount: {
      one: "{count} lokalita",
      few: "{count} lokality",
      many: "{count} lokality",
    ...
    asnExchangeCount: {
      one: "{count} výměnný uzel",
      few: "{count} výměnné uzly",
      many: "{count} výměnného uzlu",
      other: "{count} výměnných uzlů",
    },
    asnConnectionCount: { one: "{count} spojení", other: "{count} spojení" },
    asnShowMore: "Zobrazit další ({count})",
    asnListedOfTotal: "{shown} z {total} záznamů",
    asnNoneReported: "Nebylo nahlášeno nic",
    asnRelationV4Peers: "IPv4 peers",
    asnRelationV6Peers: "IPv6 peers",
    asnRelationObservedVia: "Váhy a počty peerů pozorovány přes {source}.",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "Platné",
    asnRpkiInvalidShort: "Neplatné",
    asnLabelExchanges: "Výměnné uzly",
    asnLabelFacilities: "Lokality",
    asnLabelPeeringDbRecord: "Záznam PeeringDB",
    asnViewOnPeeringDb: "Zobrazit {name} na PeeringDB",
    asnIxNotOperational: "Není v provozu",
    asnSortLabel: "Seřadit",
    asnSortDefault: "Pořadí poskytovatele",
    asnSameAsn: "Shodné s tímto ASN",
    asnExamplesLabel: "Vyzkoušejte",
    asnLabelPolicy: "Politika",
    asnCountryCount: {
      one: "ve {count} zemi",
      few: "ve {count} zemích",
      many: "ve {count} zemi",
      other: "ve {count} zemích",
    },
  ...
  sv: {
    ...
    asnTabPrefixes: "Prefix",
    asnTabPeering: "Peering",
    asnTabSources: "Källor",
    asnDetailNavLabel: "ASN-detaljer",
    asnIdentityEyebrow: "Autonomt system",
    asnCopyAsn: "Kopiera ASN",
    asnLabelType: "Typ",
    asnLabelRegistry: "Register",
    asnLabelDomain: "Domän",
    asnNetworkTypes: {
      isp: "ISP",
      hosting: "Webbhotell",
      business: "Företag",
    ...
    asnSourcesLabel: "Källor",
    asnMetricIpv4Equivalent: "≈ motsvarar /{bits}",
    asnMetricRequiresIpinfo: "Kräver IPinfo",
    asnMetricNotReported: "Ej rapporterat",
    asnMetricNoPeeringDb: "Ingen PeeringDB-profil",
    asnFacilityCount: {
      one: "{count} anläggning",
      other: "{count} anläggningar",
    },
    asnExchangeCount: {
      one: "{count} utbytespunkt",
      other: "{count} utbytespunkter",
    },
    asnConnectionCount: {
      one: "{count} anslutning",
      other: "{count} anslutningar",
    },
    asnShowMore: "Visa {count} till",
    asnListedOfTotal: "{shown} av {total} listade",
    asnNoneReported: "Inget rapporterat",
    asnRelationV4Peers: "IPv4-peers",
    asnRelationV6Peers: "IPv6-peers",
    asnRelationObservedVia: "Vikter och antal peers observerade via {source}.",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "Giltig",
    asnRpkiInvalidShort: "Ogiltig",
    asnLabelExchanges: "Utbytespunkter",
    asnLabelFacilities: "Anläggningar",
    asnLabelPeeringDbRecord: "PeeringDB-post",
    asnViewOnPeeringDb: "Visa {name} på PeeringDB",
    asnIxNotOperational: "Ej i drift",
    asnSortLabel: "Sortera",
    asnSortDefault: "Leverantörsordning",
    asnSameAsn: "Samma som det här ASN:et",
    asnExamplesLabel: "Prova",
    asnLabelPolicy: "Policy",
    asnCountryCount: { one: "i {count} land", other: "i {count} länder" },
    targetPlaceholder: "example.com",
  ...
  da: {
    ...
    asnTabRouting: "Routing",
    asnTabPrefixes: "Præfikser",
    asnTabPeering: "Peering",
    asnTabSources: "Kilder",
    asnDetailNavLabel: "Detaljer om ASN",
    asnIdentityEyebrow: "Autonomt system",
    asnCopyAsn: "Kopiér ASN",
    asnLabelType: "Type",
    asnLabelRegistry: "Register",
    asnLabelDomain: "Domæne",
    asnNetworkTypes: {
      isp: "ISP",
      hosting: "Webhotel",
      business: "Erhverv",
    ...
    asnSourcesLabel: "Kilder",
    asnMetricIpv4Equivalent: "≈ svarer til /{bits}",
    asnMetricRequiresIpinfo: "Kræver IPinfo",
    asnMetricNotReported: "Ikke rapporteret",
    asnMetricNoPeeringDb: "Ingen PeeringDB-profil",
    asnFacilityCount: { one: "{count} anlæg", other: "{count} anlæg" },
    asnExchangeCount: {
      one: "{count} udvekslingspunkt",
      other: "{count} udvekslingspunkter",
    },
    asnConnectionCount: {
      one: "{count} forbindelse",
      other: "{count} forbindelser",
    },
    asnShowMore: "Vis {count} mere",
    asnListedOfTotal: "{shown} af {total} listet",
    asnNoneReported: "Intet rapporteret",
    asnRelationV4Peers: "IPv4-peers",
    asnRelationV6Peers: "IPv6-peers",
    asnRelationObservedVia: "Vægte og antal peers observeret via {source}.",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "Gyldig",
    asnRpkiInvalidShort: "Ugyldig",
    asnLabelExchanges: "Udvekslingspunkter",
    asnLabelFacilities: "Anlæg",
    asnLabelPeeringDbRecord: "PeeringDB-post",
    asnViewOnPeeringDb: "Vis {name} på PeeringDB",
    asnIxNotOperational: "Ikke i drift",
    asnSortLabel: "Sortér",
    asnSortDefault: "Leverandørrækkefølge",
    asnSameAsn: "Samme som dette ASN",
    asnExamplesLabel: "Prøv",
    asnLabelPolicy: "Politik",
    asnCountryCount: { one: "i {count} land", other: "i {count} lande" },
    targetPlaceholder: "example.com",
  ...
  nb: {
    ...
    asnTabRouting: "Ruting",
    asnTabPrefixes: "Prefikser",
    asnTabPeering: "Peering",
    asnTabSources: "Kilder",
    asnDetailNavLabel: "Detaljer om ASN",
    asnIdentityEyebrow: "Autonomt system",
    asnCopyAsn: "Kopier ASN",
    asnLabelType: "Type",
    asnLabelRegistry: "Register",
    asnLabelDomain: "Domene",
    asnNetworkTypes: {
      isp: "ISP",
      hosting: "Webhotell",
      business: "Næringsliv",
    ...
    asnSourcesLabel: "Kilder",
    asnMetricIpv4Equivalent: "≈ tilsvarer /{bits}",
    asnMetricRequiresIpinfo: "Krever IPinfo",
    asnMetricNotReported: "Ikke rapportert",
    asnMetricNoPeeringDb: "Ingen PeeringDB-profil",
    asnFacilityCount: { one: "{count} anlegg", other: "{count} anlegg" },
    asnExchangeCount: {
      one: "{count} utvekslingspunkt",
      other: "{count} utvekslingspunkter",
    },
    asnConnectionCount: {
      one: "{count} tilkobling",
      other: "{count} tilkoblinger",
    },
    asnShowMore: "Vis {count} flere",
    asnListedOfTotal: "{shown} av {total} oppført",
    asnNoneReported: "Ingenting rapportert",
    asnRelationV4Peers: "IPv4-peers",
    asnRelationV6Peers: "IPv6-peers",
    asnRelationObservedVia: "Vekter og antall peers observert via {source}.",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "Gyldig",
    asnRpkiInvalidShort: "Ugyldig",
    asnLabelExchanges: "Utvekslingspunkter",
    asnLabelFacilities: "Anlegg",
    asnLabelPeeringDbRecord: "PeeringDB-post",
    asnViewOnPeeringDb: "Vis {name} på PeeringDB",
    asnIxNotOperational: "Ikke i drift",
    asnSortLabel: "Sorter",
    asnSortDefault: "Leverandørrekkefølge",
    asnSameAsn: "Samme som dette ASN-et",
    asnExamplesLabel: "Prøv",
    asnLabelPolicy: "Policy",
    asnCountryCount: { one: "i {count} land", other: "i {count} land" },
    targetPlaceholder: "example.com",
    ...
    asnTabRouting: "Reititys",
    asnTabPrefixes: "Etuliitteet",
    asnTabPeering: "Peering",
    asnTabSources: "Lähteet",
    asnDetailNavLabel: "ASN-tiedot",
    asnIdentityEyebrow: "Autonominen järjestelmä",
    asnCopyAsn: "Kopioi ASN",
    asnLabelType: "Tyyppi",
    asnLabelRegistry: "Rekisteri",
    asnLabelDomain: "Verkkotunnus",
    asnNetworkTypes: {
      isp: "ISP",
      hosting: "Hosting",
    ...
    asnSourcesLabel: "Lähteet",
    asnMetricIpv4Equivalent: "≈ vastaa /{bits}",
    asnMetricRequiresIpinfo: "Vaatii IPinfoa",
    asnMetricNotReported: "Ei ilmoitettu",
    asnMetricNoPeeringDb: "Ei PeeringDB-profiilia",
    asnFacilityCount: { one: "{count} laitetila", other: "{count} laitetilaa" },
    asnExchangeCount: {
      one: "{count} vaihtopiste",
      other: "{count} vaihtopistettä",
    },
    asnConnectionCount: { one: "{count} yhteys", other: "{count} yhteyttä" },
    asnShowMore: "Näytä {count} lisää",
    asnListedOfTotal: "{shown} / {total} näytetty",
    asnNoneReported: "Mitään ei ilmoitettu",
    asnRelationV4Peers: "IPv4-peerit",
    asnRelationV6Peers: "IPv6-peerit",
    asnRelationObservedVia:
      "Painot ja peerimäärät havaittu lähteestä {source}.",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "Voimassa",
    asnRpkiInvalidShort: "Virheellinen",
    asnLabelExchanges: "Vaihtopisteet",
    asnLabelFacilities: "Laitetilat",
    asnLabelPeeringDbRecord: "PeeringDB-tietue",
    asnViewOnPeeringDb: "Näytä {name} PeeringDB:ssä",
    asnIxNotOperational: "Ei käytössä",
    asnSortLabel: "Lajittele",
    asnSortDefault: "Palveluntarjoajan järjestys",
    asnSameAsn: "Sama kuin tämä ASN",
    asnExamplesLabel: "Kokeile",
    asnLabelPolicy: "Käytäntö",
    asnCountryCount: { one: "{count} maassa", other: "{count} maassa" },
    targetPlaceholder: "example.com",
  ...
  el: {
    ...
    asnTabRouting: "Δρομολόγηση",
    asnTabPrefixes: "Προθέματα",
    asnTabPeering: "Peering",
    asnTabSources: "Πηγές",
    asnDetailNavLabel: "Λεπτομέρειες ASN",
    asnIdentityEyebrow: "Αυτόνομο σύστημα",
    asnCopyAsn: "Αντιγραφή ASN",
    asnLabelType: "Τύπος",
    asnLabelRegistry: "Μητρώο",
    asnLabelDomain: "Τομέας",
    asnNetworkTypes: {
      isp: "ISP",
      hosting: "Hosting",
    ...
    asnSourcesLabel: "Πηγές",
    asnMetricIpv4Equivalent: "≈ αντιστοιχεί σε /{bits}",
    asnMetricRequiresIpinfo: "Απαιτεί το IPinfo",
    asnMetricNotReported: "Δεν αναφέρεται",
    asnMetricNoPeeringDb: "Δεν υπάρχει προφίλ PeeringDB",
    asnFacilityCount: {
      one: "{count} εγκατάσταση",
      other: "{count} εγκαταστάσεις",
    },
    asnExchangeCount: {
      one: "{count} σημείο ανταλλαγής",
      other: "{count} σημεία ανταλλαγής",
    },
    asnConnectionCount: { one: "{count} σύνδεση", other: "{count} συνδέσεις" },
    asnShowMore: "Εμφάνιση περισσότερων ({count})",
    asnListedOfTotal: "{shown} από {total} εγγραφές",
    asnNoneReported: "Δεν αναφέρθηκε τίποτα",
    asnRelationV4Peers: "Peers IPv4",
    asnRelationV6Peers: "Peers IPv6",
    asnRelationObservedVia:
      "Τα βάρη και οι αριθμοί των peers παρατηρήθηκαν μέσω {source}.",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "Έγκυρο",
    asnRpkiInvalidShort: "Άκυρο",
    asnLabelExchanges: "Σημεία ανταλλαγής",
    asnLabelFacilities: "Εγκαταστάσεις",
    asnLabelPeeringDbRecord: "Εγγραφή PeeringDB",
    asnViewOnPeeringDb: "Προβολή του {name} στο PeeringDB",
    asnIxNotOperational: "Δεν λειτουργεί",
    asnSortLabel: "Ταξινόμηση",
    asnSortDefault: "Σειρά παρόχου",
    asnSameAsn: "Ίδιο με αυτό το ASN",
    asnExamplesLabel: "Δοκιμάστε",
    asnLabelPolicy: "Πολιτική",
    asnCountryCount: { one: "σε {count} χώρα", other: "σε {count} χώρες" },
    targetPlaceholder: "example.com",
  ...
  ro: {
    ...
    asnTabRouting: "Rutare",
    asnTabPrefixes: "Prefixe",
    asnTabPeering: "Peering",
    asnTabSources: "Surse",
    asnDetailNavLabel: "Detalii ASN",
    asnIdentityEyebrow: "Sistem autonom",
    asnCopyAsn: "Copiază ASN",
    asnLabelType: "Tip",
    asnLabelRegistry: "Registru",
    asnLabelDomain: "Domeniu",
    asnNetworkTypes: {
      isp: "ISP",
      hosting: "Găzduire",
      business: "Afaceri",
      education: "Educație",
      government: "Administrație publică",
      inactive: "Inactiv",
    },
    asnSourcesLabel: "Surse",
    asnMetricIpv4Equivalent: "≈ echivalent cu /{bits}",
    asnMetricRequiresIpinfo: "Necesită IPinfo",
    asnMetricNotReported: "Nu este raportat",
    asnMetricNoPeeringDb: "Fără profil PeeringDB",
    asnFacilityCount: { one: "{count} locație", few: "{count} locații", other: "{count} de locații" },
    asnExchangeCount: {
      one: "{count} punct de schimb",
      few: "{count} puncte de schimb",
      other: "{count} de puncte de schimb",
    },
    asnConnectionCount: {
      one: "{count} conexiune",
      few: "{count} conexiuni",
    ...
    asnShowMore: "Afișează încă {count}",
    asnListedOfTotal: "{shown} din {total} afișate",
    asnNoneReported: "Nu s-a raportat nimic",
    asnRelationV4Peers: "Peers IPv4",
    asnRelationV6Peers: "Peers IPv6",
    asnRelationObservedVia:
      "Ponderile și numărul de peers observate prin {source}.",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "Valid",
    asnRpkiInvalidShort: "Invalid",
    asnLabelExchanges: "Puncte de schimb",
    asnLabelFacilities: "Locații",
    asnLabelPeeringDbRecord: "Înregistrare PeeringDB",
    asnViewOnPeeringDb: "Vezi {name} pe PeeringDB",
    asnIxNotOperational: "Nu este în funcțiune",
    asnSortLabel: "Sortează",
    asnSortDefault: "Ordinea furnizorului",
    asnSameAsn: "Același cu acest ASN",
    asnExamplesLabel: "Încearcă",
    asnLabelPolicy: "Politică",
    asnCountryCount: { one: "în {count} țară", few: "în {count} țări", other: "în {count} de țări" },
    targetPlaceholder: "example.com",
  ...
  tr: {
    ...
    asnTabRouting: "Yönlendirme",
    asnTabPrefixes: "Prefixler",
    asnTabPeering: "Peering",
    asnTabSources: "Kaynaklar",
    asnDetailNavLabel: "ASN ayrıntıları",
    asnIdentityEyebrow: "Otonom sistem",
    asnCopyAsn: "ASN’yi kopyala",
    asnLabelType: "Tür",
    asnLabelRegistry: "Kayıt kuruluşu",
    asnLabelDomain: "Alan adı",
    asnNetworkTypes: {
      isp: "ISP",
      hosting: "Barındırma",
      business: "İşletmeler",
    ...
    asnSourcesLabel: "Kaynaklar",
    asnMetricIpv4Equivalent: "≈ /{bits} eşdeğeri",
    asnMetricRequiresIpinfo: "IPinfo gerekir",
    asnMetricNotReported: "Bildirilmedi",
    asnMetricNoPeeringDb: "PeeringDB profili yok",
    asnFacilityCount: { one: "{count} tesis", other: "{count} tesis" },
    asnExchangeCount: {
      one: "{count} değişim noktası",
      other: "{count} değişim noktası",
    },
    asnConnectionCount: { one: "{count} bağlantı", other: "{count} bağlantı" },
    asnShowMore: "{count} tane daha göster",
    asnListedOfTotal: "{shown} / {total} listelendi",
    asnNoneReported: "Bildirilen yok",
    asnRelationV4Peers: "IPv4 peerleri",
    asnRelationV6Peers: "IPv6 peerleri",
    asnRelationObservedVia:
      "{source} üzerinden gözlemlenen ağırlıklar ve peer sayıları.",
    asnRpkiLabel: "RPKI",
    asnRpkiValidShort: "Geçerli",
    asnRpkiInvalidShort: "Geçersiz",
    asnLabelExchanges: "Değişim noktaları",
    asnLabelFacilities: "Tesisler",
    asnLabelPeeringDbRecord: "PeeringDB kaydı",
    asnViewOnPeeringDb: "{name} kaydını PeeringDB’de görüntüle",
    asnIxNotOperational: "Çalışmıyor",
    asnSortLabel: "Sırala",
    asnSortDefault: "Sağlayıcı sırası",
    asnSameAsn: "Bu ASN ile aynı",
    asnExamplesLabel: "Deneyin",
    asnLabelPolicy: "Politika",
    asnCountryCount: { one: "{count} ülkede", other: "{count} ülkede" },
    targetPlaceholder: "example.com",
