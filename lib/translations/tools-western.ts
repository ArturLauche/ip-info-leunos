...
export const toolsWestern: Record<"es" | "fr" | "it" | "nl", ToolTranslation> =
  {
    es: {
      ...
      asnMetricIpinfoDetail: "Datos de ASN de IPinfo, si están configurados",
      asnMetricAnnouncedPrefixesDetail: "Prefijos anunciados",
      asnMetricBgpRelationshipsDetail: "Relaciones BGP de IPinfo o RIPEstat",
      asnMetricPeeringDbProfileDetail: "Perfil de red de PeeringDB",
      asnPrefixIpCount: "IP",
    ...
    fr: {
      ...
      asnMetricIpinfoDetail: "Données ASN IPinfo, si configurées",
      asnMetricAnnouncedPrefixesDetail: "Préfixes annoncés",
      asnMetricBgpRelationshipsDetail: "Relations BGP IPinfo ou RIPEstat",
      asnMetricPeeringDbProfileDetail: "Profil réseau PeeringDB",
      asnPrefixIpCount: "IP",
    ...
    it: {
      ...
      asnMetricIpinfoDetail: "Dati ASN IPinfo, se configurati",
      asnMetricAnnouncedPrefixesDetail: "Prefissi annunciati",
      asnMetricBgpRelationshipsDetail: "Relazioni BGP di IPinfo o RIPEstat",
      asnMetricPeeringDbProfileDetail: "Profilo di rete PeeringDB",
      asnPrefixIpCount: "IP",
    ...
    nl: {
      ...
      asnMetricIpinfoDetail: "IPinfo-ASN-gegevens, indien geconfigureerd",
      asnMetricAnnouncedPrefixesDetail: "Aangekondigde voorvoegsels",
      asnMetricBgpRelationshipsDetail: "BGP-relaties van IPinfo of RIPEstat",
      asnMetricPeeringDbProfileDetail: "PeeringDB-netwerkprofiel",
