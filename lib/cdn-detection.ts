/**
 * CDN provider detection from response headers and DNS CNAME chains.
 *
 * Pure scoring logic kept out of the route module: route files may only
 * export handlers and segment config, and keeping this here makes the
 * signature table independently testable.
 */
...
function mapScoreToConfidence(score: number): CdnConfidence {
