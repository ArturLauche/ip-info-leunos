...
// Absolute URL: some scrapers (iMessage, Slack, non-browser bots) do not
// resolve relative og:image URLs against metadataBase.
export const defaultOpenGraphImage = `${siteConfig.url}/og-image.png`;
...
export function createPageMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      alternateLocale: ["en_US", "es_ES", "fr_FR", "pt_BR", "ja_JP", "ru_RU", "zh_CN"],
      url: canonical,
      title,
      description,
