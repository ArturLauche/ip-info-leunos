...
import type { Direction, Locale } from "@/lib/locale-config";
import { coreAsian } from "@/lib/translations/core-asian";
import { coreEuropean } from "@/lib/translations/core-european";
import { coreMore } from "@/lib/translations/core-more";
import { corePortuguese } from "@/lib/translations/core-portuguese";
import { coreWestern } from "@/lib/translations/core-western";
...
export const translations: Record<Locale, Translation> = Object.assign(
  {
    de: {
    ...
    en: {
      ...
      possibleLocalProxy:
        "Possible enterprise, school, or local proxy signals detected",
    ...
    es: {
      ...
      checkEmptyTitle: "Consulta cualquier dirección IP o dominio",
      checkEmptyDescription:
        "Introduce una IPv4, IPv6 o un dominio para ver su ubicación, red, ASN, DNS inverso y detalles de conexión.",
      connectionTypes: {
    ...
    fr: {
      ...
      checkEmptyTitle: "Rechercher n'importe quelle adresse IP ou domaine",
      checkEmptyDescription:
        "Saisissez une IPv4, une IPv6 ou un domaine pour voir sa localisation, son réseau, son ASN, le DNS inverse et les détails de connexion.",
      connectionTypes: {
    ...
    "pt-BR": {
      ...
      checkEmptyDescription:
        "Digite um IPv4, IPv6 ou domínio para ver localização, rede, ASN, DNS reverso e detalhes da conexão.",
      connectionTypes: {
    ...
    ru: {
      ...
      checkEmptyTitle: "Проверить любой IP-адрес или домен",
      checkEmptyDescription:
        "Введите IPv4, IPv6 или домен, чтобы увидеть местоположение, сеть, ASN, обратный DNS и сведения о подключении.",
      connectionTypes: {
    ...
    "zh-CN": {
      ...
      checkEmptyTitle: "查询任意 IP 地址或域名",
      checkEmptyDescription:
        "输入 IPv4、IPv6 或域名，查看位置、网络、ASN、反向 DNS 和连接详情。",
      connectionTypes: {
        datacenter: "数据中心 / 托管",
        tor: "Tor 出口节点",
        vpn: "VPN / 匿名服务",
