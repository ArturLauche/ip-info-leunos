...
export type Translation = {
  ...
  fingerprintSchemaLabel: string;
  fingerprintInputsLabel: string;
  fingerprintInputs: string[];
  fingerprintDisclaimer: string;
  deviceTypes: {
    desktop: string;
    mobile: string;
    tablet: string;
...
export const translations: Record<Locale, Translation> = {
  de: {
    ...
    fingerprintSchema: "v1",
    fingerprintSchemaLabel: "Schema",
    fingerprintInputsLabel: "Eingaben",
    fingerprintInputs: [
      "Browser",
      "Hauptversion",
      "Betriebssystem",
    ...
    fingerprintDisclaimer:
      "Lokal aus einer festen Menge von Browser-Signalen gehasht. Wird nicht an einen Server gesendet und nicht gespeichert.",
    deviceTypes: {
      desktop: "Desktop",
      mobile: "Mobilgerät",
      tablet: "Tablet",
  ...
  en: {
    ...
    fingerprintDisclaimer:
      "Hashed locally from a fixed set of browser signals. Never sent to a server or persisted.",
    deviceTypes: {
      desktop: "Desktop",
      mobile: "Mobile",
      tablet: "Tablet",
  ...
  es: {
    ...
    fingerprintAlgorithm: "SHA-256",
    fingerprintSchema: "v1",
    fingerprintSchemaLabel: "Esquema",
    fingerprintInputsLabel: "Entradas",
    fingerprintInputs: [
      "Navegador",
      "Versión principal",
      "Sistema operativo",
    ...
    fingerprintDisclaimer:
      "Se hashea localmente a partir de un conjunto fijo de señales del navegador. No se envía a ningún servidor ni se almacena.",
    deviceTypes: {
      desktop: "Escritorio",
      mobile: "Móvil",
      tablet: "Tableta",
  ...
  fr: {
    ...
    fingerprintAlgorithm: "SHA-256",
    fingerprintSchema: "v1",
    fingerprintSchemaLabel: "Schéma",
    fingerprintInputsLabel: "Entrées",
    fingerprintInputs: [
      "Navigateur",
      "Version principale",
    ...
    fingerprintDisclaimer:
      "Hachée localement à partir d’un ensemble fixe de signaux du navigateur. Jamais envoyée à un serveur ou persistée.",
    deviceTypes: {
      desktop: "Ordinateur",
      mobile: "Mobile",
      tablet: "Tablette",
  ...
  "pt-BR": {
    ...
    fingerprintDisclaimer:
      "Calculada localmente a partir de um conjunto fixo de sinais do navegador. Nunca enviado para um servidor ou persistido.",
    deviceTypes: {
      desktop: "Desktop",
      mobile: "Celular",
      tablet: "Tablet",
  ...
  ja: {
    ...
    fingerprintAlgorithm: "SHA-256",
    fingerprintSchema: "v1",
    fingerprintSchemaLabel: "スキーマ",
    fingerprintInputsLabel: "入力",
    fingerprintInputs: [
      "ブラウザ",
      "メインバージョン",
      "オペレーティングシステム",
    ...
    fingerprintDisclaimer:
      "固定されたブラウザシグナルの集合からローカルでハッシュされます。サーバーに送信されたり、永続化されたりすることはありません。",
    deviceTypes: {
      desktop: "デスクトップ",
      mobile: "モバイル",
      tablet: "タブレット",
  ...
  ru: {
    ...
    fingerprintAlgorithm: "SHA-256",
    fingerprintSchema: "v1",
    fingerprintSchemaLabel: "Схема",
    fingerprintInputsLabel: "Входные данные",
    fingerprintInputs: [
      "Браузер",
      "Основная версия",
    ...
    fingerprintDisclaimer:
      "Хешируется локально по фиксированному набору сигналов браузера. Не передаётся на сервер и не сохраняется.",
    deviceTypes: {
      desktop: "Компьютер",
      mobile: "Смартфон",
      tablet: "Планшет",
  ...
  "zh-CN": {
    ...
    fingerprintAlgorithm: "SHA-256",
    fingerprintSchema: "v1",
    fingerprintSchemaLabel: "架构",
    fingerprintInputsLabel: "输入项",
    fingerprintInputs: [
      "浏览器",
      "主版本",
      "操作系统",
    ...
    fingerprintDisclaimer:
      "基于浏览器信号的固定集合在本地进行哈希处理。不会发送到服务器，也不会被持久化存储。",
    deviceTypes: {
      desktop: "桌面设备",
      mobile: "手机",
      tablet: "平板",
