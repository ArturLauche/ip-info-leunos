...
export async function GET(request: Request, context: RouteContext) {
  // Same guard order as every other public route: flags are cheap and
  // immutable, so the limit is generous — it only stops unauthenticated
  // fan-out amplification to the upstream CDN.
